...
const DashboardPage = () => {
  ...
  // it would be better to send the last 5 items from the api, instead of slicing it here (Il serait meilleur de renvoyer les 5 derniers éléments de l'api, au lieu de le couper ici)
  // but we're just keeping it simple here...(mais nous gardons juste la simplicité ici)
