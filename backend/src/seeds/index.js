...
const seedDatabase = async () => {
  try {
    ...
    // Clear existing products (Supprimer les produits existants)
    await Product.deleteMany({});
    console.log("🗑️  Cleared existing products");

    // Insert seed products (Insérer des produits de test)
    ...
    // Close connection (Fermeture de la connexion)
...
// Run the seed function (Exécuter la fonction de test)
seedDatabase();